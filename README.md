...
All font files in the folder `fonts/nimblebeastscollective.itch.io/*` were provided as [Creative Commons 0](https://creativecommons.org/publicdomain/zero/1.0/), and so they are also covered under the same license in this repository.

A special thanks to the specific authors of the fonts used by this project:
- [PaulSpades](https://itch.io/profile/paul-spades) - Author of KarenFat
- Omni - Author of Habbo
- DuffsDevice - Author of TinyUnicode

#### Nonsensical 2D ([youtube.com](https://www.youtube.com/@Nonsensical2D))

Thanks to Nonsensical 2D whose [video about nice looking autotiles](https://www.youtube.com/watch?v=YtvPeEMSY3k) helped me design the tilemaps for this game.
